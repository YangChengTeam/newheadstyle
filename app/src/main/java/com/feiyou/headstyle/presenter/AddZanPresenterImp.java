...
public class AddZanPresenterImp extends BasePresenterImp<IBaseView, ZanResultRet> implements AddZanPresenter {
    ...
    @Override
    public void addZan(int type, String userId,String zanUserId,String messageId, String commentId, String repeatId,int modelType) {
        addZanModelImp.addZan(type, userId, zanUserId,messageId, commentId, repeatId, modelType,this);
    }
}
