...
public class FollowModelImp extends BaseModel implements FollowModel<FollowInfoRet> {
    ...
    private TopicDataServiceApi topicDataServiceApi;
    ...
    public FollowModelImp(Context mContext) {
        ...
        topicDataServiceApi = mRetrofit.create(TopicDataServiceApi.class);
    ...
    @Override
    public void followTopic(String userId, String topicId, IBaseRequestCallBack<FollowInfoRet> iBaseRequestCallBack) {
        JSONObject params = new JSONObject();
        try {
            params.put("user_id", userId);
        ...
        mCompositeSubscription.add(topicDataServiceApi.topicFollow(requestBody)  //将subscribe添加到subscription，用于注销subscribe
                .observeOn(AndroidSchedulers.mainThread())//指定事件消费线程
                .subscribeOn(Schedulers.io())  //指定 subscribe() 发生在 IO 线程
                .subscribe(new Subscriber<FollowInfoRet>() {
