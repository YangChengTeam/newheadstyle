...
public class HeadListDataModelImp extends BaseModel implements HeadListDataModel<HeadInfoRet> {
    ...
    @Override
    public void userCollection(int page, String userId, IBaseRequestCallBack<HeadInfoRet> iBaseRequestCallBack) {
        ...
        mCompositeSubscription.add(headListDataServiceApi.userCollection(requestBody)  //将subscribe添加到subscription，用于注销subscribe
