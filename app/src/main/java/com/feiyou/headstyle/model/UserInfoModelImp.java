...
public class UserInfoModelImp extends BaseModel implements UserInfoModel<UserInfoRet> {
    ...
    public void updateUserInfo(UserInfo updateInfo, IBaseRequestCallBack<UserInfoRet> iBaseRequestCallBack) {
        ...
        try {
            ...
            params.put("star", updateInfo.getStar());
    ...
    @Override
    public void updateTxOpenId(String uid, String txopenid, String txnickname, IBaseRequestCallBack<UserInfoRet> iBaseRequestCallBack) {
        JSONObject params = new JSONObject();
        try {
            params.put("user_id", uid);
            params.put("txopenid", txopenid);
            params.put("txnickname", txnickname);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json"), params.toString());
